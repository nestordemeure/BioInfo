	...
	public static void main(String[] args) throws Exception {
		...
		Callable<Boolean> callable =  new Callable<Boolean>(){
			public Boolean call() throws Exception{
				Scanner sc = new Scanner(Resources.asByteSource(new URL("https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=nuccore&id=NC_008944.1&rettype=gb")).openBufferedStream());
				...
				URL url = new File("/home/nestor/Cours/2A/bioinformatique/sequenceb.gb").toURI().toURL();
